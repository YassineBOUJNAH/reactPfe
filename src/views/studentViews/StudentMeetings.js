...
class StudentMeetings extends React.Component {
    ...
    render() {
        ...
        if (this.state.selectedinternship == null) {
            ...
            studentcomp = <SupervisorModal isopen={this.state.isStudentModalOpen} togglemodal={this.toggleModalS2} internship={
